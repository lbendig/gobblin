...
/**
 * Wraps Kafka011 Deserializer for a generic access in KafkaDeserializerExtractor
 *
 */
@Alias(value = "KafkaDeserializerWrapper")public class KafkaDeserializerWrapper implements DeserializerWrapper {
