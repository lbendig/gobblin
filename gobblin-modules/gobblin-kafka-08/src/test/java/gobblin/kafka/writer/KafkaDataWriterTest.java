...
public class KafkaDataWriterTest {
  ...
  public void testStringSerialization()
    ...
    KafkaDataWriter<String> kafka08DataWriter = new KafkaDataWriter<String>(props);
  ...
  public void testBinarySerialization()
    ...
    KafkaDataWriter<byte[]> kafka08DataWriter = new KafkaDataWriter<byte[]>(props);
    WriteCallback callback = mock(WriteCallback.class);
  ...
  public void testAvroSerialization()
    ...
    KafkaDataWriter<GenericRecord> kafka08DataWriter = new KafkaDataWriter<>(props);
    WriteCallback callback = mock(WriteCallback.class);
