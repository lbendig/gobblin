...
import gobblin.kafka.client.KafkaConsumerClient.Kafka09ConsumerRecord;
...
public class KafkaConsumerClientTest {
  ...
  public void testConsume() throws Exception {
    ...
    Config testConfig = ConfigFactory.parseMap(ImmutableMap.of(
        ConfigurationKeys.KAFKA_BROKERS, "test", 
    ...
    try (KafkaConsumerClient<String, String> kafka09Client = new KafkaConsumerClient<>(testConfig, consumer);) {
